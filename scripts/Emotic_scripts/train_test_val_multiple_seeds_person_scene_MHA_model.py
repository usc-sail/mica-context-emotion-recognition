...
train_test_val_tune_config_file="/home/dbose_usc_edu/codes/context-emotion-recognition/configs/config_person_scene_MHA_train_test_val_multiple_seeds.yaml"
...
for seed_value in seed_value_list:
    ...
    model=person_MHA_model_scene_AVD_Discrete(**model_dict)
