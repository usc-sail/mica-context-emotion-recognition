...
train_test_val_config_file="/data/digbose92/emotic_experiments/context-emotion-recognition/configs/config_caption_person_MHA_model_scene_late_fusion_AVD_discrete_train_test_val_multiple_seeds.yaml"
...
for seed_value in seed_value_list:
    ...
    model_dict={
            ...
            'person_max_len':config_data['model']['person_max_len'],
    ...
    model=caption_person_dual_MHA_model_scene_late_fusion_AVD_Discrete(**model_dict)
