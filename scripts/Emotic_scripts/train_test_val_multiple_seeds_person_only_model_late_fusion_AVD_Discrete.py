...
from dataset import *
from person_only_model_finetuned import *
...
train_test_val_config_file="/home/dbose_usc_edu/codes/context-emotion-recognition/configs/config_person_only_model_AVD_Discrete_train_test_val_multiple_seeds.yaml"
...
for seed_value in seed_value_list:
    ...
    train_pds=Person_dataset_finetuned_network_AVD_discrete(
    ...
    val_pds=Person_dataset_finetuned_network_AVD_discrete(
    ...
    test_pds=Person_dataset_finetuned_network_AVD_discrete(
    ...
    model=person_model_resnet_finetuned_AVD_Discrete(**model_dict)
    ...
    for epoch in range(1, max_epochs+1): #main outer loop
            ...
            for return_dict in tqdm(train_dl):
                ...
                logits_cont,logits_discrete=model(image_array)
            ...
            val_loss,cont_loss,map_score_val,val_corr_score,map_score_list=gen_validate_score_multi_label_model_person_fully_ft_discrete_cont(model,val_dl,device,discrete_criterion,continuous_criterion,weight_discrete,weight_continuous)
    ...
    model.eval()
    test_loss,cont_test_loss,map_score_test,test_corr_score,map_score_list=gen_validate_score_multi_label_model_person_fully_ft_discrete_cont(model,test_dl,device,discrete_criterion,continuous_criterion,weight_discrete,weight_continuous)
