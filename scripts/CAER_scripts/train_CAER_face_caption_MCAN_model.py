...
def main(config_data):
    ...
    train_pds=CAER_Face_Caption_Feature_AVD_Discrete_dataset(
            tokenizer=tokenizer,
    ...
    val_pds=CAER_Face_Caption_Feature_AVD_Discrete_dataset(
            tokenizer=tokenizer,
    ...
    model_dict={
            ...
            'text_feat_dim':config_data['model']['text_feat_dim'],
            'face_model':feature_model,
            'num_classes':config_data['model']['n_discrete_classes'],
            'text_model': config_data['model']['text_model'] 
    }
    
    model=text_face_MCAN_AVD_Discrete(**model_dict)
    ...
    for epoch in range(1, max_epochs+1): #main outer loop
            ...
            valid_accuracy,f1_score_val,precision_score_val,recall_score_val,val_loss=gen_validate_score_face_only_model_with_text_MCAN(val_dl,model,device,discrete_criterion)
